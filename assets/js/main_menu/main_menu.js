...
arrowimages: {down:['downarrowclass', 'assets/js/main_menu/arrow-down.svg', 23], right:['rightarrowclass', 'assets/js/main_menu/arrow-right.svg', 6], left:['leftarrowclass', 'assets/js/main_menu/arrow-left.svg']},
...
function helpCallUs(){
	...
	$topulref.append(sigIn(), favorites(),cart(),ourStore(),order(),helpCallUs()) // my mod
